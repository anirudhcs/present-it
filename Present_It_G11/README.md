App Engine application for the Present-It project.
The code comes straight from the udacity course, lesson 5. I am not sure of the licences and stuff. For now we are using it. the originl license stays in this folder.
