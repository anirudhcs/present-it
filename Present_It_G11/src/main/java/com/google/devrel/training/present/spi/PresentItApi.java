...
import com.google.devrel.training.present.form.ConferenceForm;
import com.google.devrel.training.present.form.ConferenceQueryForm;
import com.google.devrel.training.present.form.ProfileForm;
import com.google.devrel.training.present.form.ProfileForm.TeeShirtSize;
import com.google.devrel.training.present.spi.ConferenceApi.WrappedBoolean;
 ...
 */
@Api(name = "present-it", version = "v1", scopes = { Constants.EMAIL_SCOPE }, clientIds = {
        Constants.WEB_CLIENT_ID, Constants.API_EXPLORER_CLIENT_ID },
        description = "API for the Present It Backend application.")
